...
namespace airDucts
{
	...
	class Perehod
	{
		...
		public void createPrPrPerehod(double dlin,double dlin1, double shir,double shir1, double vys, double zazor, IModelDoc2 Part)
		{
			...
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(-dlin1 / 2, 0, 0, -dlin1 / 2, shir1 / 2, 0);
			...
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(dlin1 / 2, -shir1 / 2, 0.0, -dlin1 / 2, -shir1 / 2, 0.0);
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(-dlin1 / 2, -shir1 / 2, 0.0, -dlin1 / 2, -zazor, 0.0);
			Part.ClearSelection2(true);
		...
		public void createPrPerehod(double dlin, double shir, double diam, double vys, double zazor, IModelDoc2 Part)
		{
			...
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(dlin / 2, shir / 2, 0.0, dlin / 2, -shir / 2, 0.0);
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(dlin / 2, -shir / 2, 0.0, -dlin / 2, -shir / 2, 0.0);
			skSegment = (SketchSegment)Part.SketchManager.CreateLine(-dlin / 2, -shir / 2, 0.0, -dlin / 2, -zazor - 0.001, 0.0);
			Part.SetPickMode();
			Part.ClearSelection2(true);
			//Part.SketchManager.InsertSketch(true);
			...
			boolstatus = Part.Extension.SelectByID2("Point6", "SKETCHPOINT", -dlin / 2, -zazor - 0.001, 0.0, true, 0, null, 0);
			...
			var myDimension1 = Part.Parameter("D1@Эскиз2");
